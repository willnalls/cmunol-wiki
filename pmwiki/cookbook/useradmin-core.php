...
XLSDV('en', array(
    ...
    'UA_invalid_username_alt' => 'Username is not valid -- must only contain characters a-z and 0-9',
...
#echo "MPN=<pre>".MatchPageNames(array_keys($ary), $pat)."</pre><br>\n";
	...
	function HandleNew($pagename) {
		...
		if(!preg_match("/^[a-z0-9]+$/",$username)) $result['username'] = 'UA_invalid_username_alt';

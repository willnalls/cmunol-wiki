...
/* copied and altered from:
   ...
   Needs PmWiki 2.2.56+
   ##removed lines from original code
*/
$RecipeInfo['foxtest']['Version'] = '2020-12-01';
...
# add action NOLcreate
$HandleActions['Foxcreate'] = 'FoxHandleCreate';

function FoxHandleCreate($pagename) {
	#echo $pagename; exit;

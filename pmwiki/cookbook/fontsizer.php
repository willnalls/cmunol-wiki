...
*/ 
# Version date
$RecipeInfo['Fontsizer']['Version'] = '2006-10-28';
...
<script type='text/javascript' language='JavaScript1.2' src='$FarmPubDirUrl/fontsizer/fontsizer.js'></script>
";
...
if($javascript==1) { $FSLinksFmt = 
        "<span id='fsbox' name='fsbox' class='fsbox'><span class='fslinklabel'>$FSLabel</span><a accesskey='-' href='#' onclick='fontSize.setSize(\"-1\"); return false;'
